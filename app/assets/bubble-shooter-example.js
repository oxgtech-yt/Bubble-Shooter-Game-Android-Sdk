...
//
// Bubble Shooter Pro - Developed by Team Wing
// ------------------------------------------------------------------------
...
window.onload = function() {
    ...
    function createSounds() {
        // Shoot sound
        sounds.shoot = createTone(440, 0.1, 'square');
        // Pop sound
        sounds.pop = createTone(660, 0.15, 'sine');
        // Cluster removal sound
        sounds.cluster = createTone(880, 0.2, 'triangle');
        // Game over sound
        sounds.gameOver = createTone(220, 0.5, 'sawtooth');
        // Success sound
        sounds.success = createTone(1320, 0.3, 'sine');
    }
    ...
    function resizeCanvas() {
        ...
        var scaleY = (containerHeight - 100) / gameHeight; // Leave space for UI
        ...
        // Calculate offset for mouse/touch coordinates
    ...
    function drawFrame() {
        ...
        context.fillStyle = "#ffffff";
        context.font = "24px Verdana";
        context.fillText("Bubble Shooter Pro", 10, 37);
    ...
    function nextBubble() {
        ...
        if (existingcolors.length == 0) {
            // Level completed! Play success sound and start new level
            playSound('success');
            setTimeout(function() {
                newGame(); // Start a new level
            }, 1000);
            return;
        }
    ...
    function handleInput(clientX, clientY) {
        var pos = getCanvasCoordinates(clientX, clientY);
    ...
    // Get the mouse position (legacy function, kept for compatibility)
